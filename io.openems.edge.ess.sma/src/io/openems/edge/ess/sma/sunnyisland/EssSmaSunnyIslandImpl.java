...
import io.openems.edge.ess.sma.sunnyisland.enums.PowerSupplyStatus;
import io.openems.edge.ess.sma.sunnyisland.enums.SetControlMode;
...
public class EssSmaSunnyIslandImpl extends AbstractOpenemsModbusComponent
		implements HybridEss, ManagedSinglePhaseEss, SinglePhaseEss, ManagedAsymmetricEss, AsymmetricEss,
	...
	private void activate(ComponentContext context, Config config) throws OpenemsException {
		...
		// TODO get values from sunspec protocol, this is a temp solution
		this.addChannelListenerForHybridEss();
	}
	...
	protected ModbusProtocol defineModbusProtocol() throws OpenemsException {
		// oEMS start
		AbstractModbusElement<?, ?, ?> activePowerL1 = null;
		AbstractModbusElement<?, ?, ?> activePowerL2 = null;
		AbstractModbusElement<?, ?, ?> activePowerL3 = null;
		AbstractModbusElement<?, ?, ?> reactivePowerL1 = null;
		AbstractModbusElement<?, ?, ?> reactivePowerL2 = null;
		AbstractModbusElement<?, ?, ?> reactivePowerL3 = null;
		// SMA seems to always use register 30777 == ACTIVE_POWER_L1 even if is
		// configured for L2 or L3
		switch (this.config.phase()) {
		case L1:
		case ALL:
			activePowerL1 = m(AsymmetricEss.ChannelId.ACTIVE_POWER_L1, new SignedDoublewordElement(30777));
			activePowerL2 = m(AsymmetricEss.ChannelId.ACTIVE_POWER_L2, new SignedDoublewordElement(30779));
			activePowerL3 = m(AsymmetricEss.ChannelId.ACTIVE_POWER_L3, new SignedDoublewordElement(30781));
			reactivePowerL1 = m(AsymmetricEss.ChannelId.REACTIVE_POWER_L1, new SignedDoublewordElement(30807),
					ElementToChannelConverter.INVERT);
			reactivePowerL2 = m(AsymmetricEss.ChannelId.REACTIVE_POWER_L2, new SignedDoublewordElement(30809),
					ElementToChannelConverter.INVERT);
			reactivePowerL3 = m(AsymmetricEss.ChannelId.REACTIVE_POWER_L3, new SignedDoublewordElement(30811),
					ElementToChannelConverter.INVERT);
			break;
		case L2:
			activePowerL1 = m(AsymmetricEss.ChannelId.ACTIVE_POWER_L2, new SignedDoublewordElement(30777));
			activePowerL2 = m(AsymmetricEss.ChannelId.ACTIVE_POWER_L1, new SignedDoublewordElement(30779));
			activePowerL3 = m(AsymmetricEss.ChannelId.ACTIVE_POWER_L3, new SignedDoublewordElement(30781));
			reactivePowerL1 = m(AsymmetricEss.ChannelId.REACTIVE_POWER_L2, new SignedDoublewordElement(30807),
					ElementToChannelConverter.INVERT);
			reactivePowerL2 = m(AsymmetricEss.ChannelId.REACTIVE_POWER_L1, new SignedDoublewordElement(30809),
					ElementToChannelConverter.INVERT);
			reactivePowerL3 = m(AsymmetricEss.ChannelId.REACTIVE_POWER_L3, new SignedDoublewordElement(30811),
					ElementToChannelConverter.INVERT);
			break;
		case L3:
			activePowerL1 = m(AsymmetricEss.ChannelId.ACTIVE_POWER_L3, new SignedDoublewordElement(30777));
			activePowerL2 = m(AsymmetricEss.ChannelId.ACTIVE_POWER_L1, new SignedDoublewordElement(30779));
			activePowerL3 = m(AsymmetricEss.ChannelId.ACTIVE_POWER_L2, new SignedDoublewordElement(30781));
			reactivePowerL1 = m(AsymmetricEss.ChannelId.REACTIVE_POWER_L3, new SignedDoublewordElement(30807),
					ElementToChannelConverter.INVERT);
			reactivePowerL2 = m(AsymmetricEss.ChannelId.REACTIVE_POWER_L1, new SignedDoublewordElement(30809),
					ElementToChannelConverter.INVERT);
			reactivePowerL3 = m(AsymmetricEss.ChannelId.REACTIVE_POWER_L2, new SignedDoublewordElement(30811),
					ElementToChannelConverter.INVERT);
			break;
		}
		// oEMS end
	...
	//TODO refactor this is a mere temp solution.
	private void addChannelListenerForHybridEss() {
		this.getActivePowerChannel().onSetNextValue(value -> this.getDcDischargePowerChannel().setNextValue(value));
		this.getActiveChargeEnergyChannel()
				.onSetNextValue(value -> this.getDcChargeEnergyChannel().setNextValue(value));
		this.getActiveDischargeEnergyChannel()
				.onSetNextValue(value -> this.getDcDischargeEnergyChannel().setNextValue(value));
	}
}
