...
public enum IoRevPiDigitalIoDevice implements ChannelId {
	...
	OUT_14(new BooleanDoc() //
			.accessMode(AccessMode.READ_WRITE) //
			.onChannelSetNextWriteMirrorToDebugChannel(IoRevPiDigitalIoDevice.DEBUG_OUT14)), //
	...
	OUT_15(new BooleanDoc() //
			.accessMode(AccessMode.READ_WRITE) //
			.onChannelSetNextWriteMirrorToDebugChannel(IoRevPiDigitalIoDevice.DEBUG_OUT15)), //
	...
	OUT_16(new BooleanDoc() //
			.accessMode(AccessMode.READ_WRITE) //
			.onChannelSetNextWriteMirrorToDebugChannel(IoRevPiDigitalIoDevice.DEBUG_OUT16)), //
	...
	private IoRevPiDigitalIoDevice(Doc doc) {
		this.doc = doc;
	}
