...
@interface Config {
	...
	@AttributeDefinition(name = "Reboot?", description = "Reboot, if connection to backend is broken for at least 3mins within the time window 10-20 mins after restart?")
