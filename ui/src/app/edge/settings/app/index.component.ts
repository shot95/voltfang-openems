...
import { ActivatedRoute, NavigationEnd, NavigationExtras, Router } from '@angular/router'; // oEMS NavigationEnd and Extras
...
export class IndexComponent implements OnInit, OnDestroy {
  ...
  public availableApps: AppList = {
    ...
    , shouldBeShown: () => this.edge.roleIsAtLeast(Role.ADMIN) || this.edge.comment.toLowerCase().includes("alle apps") || this.key != null, // oEMS
  };
