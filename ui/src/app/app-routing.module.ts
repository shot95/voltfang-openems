...
import { ThermometerChartOverviewComponent } from './edge/history/thermometer/chartoverview/chartoverview.component'; // oEMS
    ...
    path: 'device/:edgeId', component: EdgeComponent, children: [
      ...
      },
      {
        path: 'history', providers: [{
          ...
          { path: 'thermometerchart', component: ThermometerChartOverviewComponent }, // oEMS
