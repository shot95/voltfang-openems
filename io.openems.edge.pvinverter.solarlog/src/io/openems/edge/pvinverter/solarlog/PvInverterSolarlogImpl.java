...
public class PvInverterSolarlogImpl extends AbstractOpenemsModbusComponent
	...
	protected ModbusProtocol defineModbusProtocol() throws OpenemsException {
		var protocol = new ModbusProtocol(this, // oEMS
			...
			protocol.addTasks(//
					new FC16WriteRegistersTask(10400, //
							...
							m(PvInverterSolarlog.ChannelId.P_LIMIT_PERC, new UnsignedWordElement(10401),
									new ChannelMetaInfoReadAndWrite(10901, 10401))),
					new FC16WriteRegistersTask(10404, m(PvInverterSolarlog.ChannelId.WATCH_DOG_TAG,
	...
	public void handleEvent(Event event) {
		...
		case EdgeEventConstants.TOPIC_CYCLE_EXECUTE_WRITE -> { // oEMS
		...
		case EdgeEventConstants.TOPIC_CYCLE_AFTER_PROCESS_IMAGE -> this.calculateProductionEnergy
				.update(this.getActivePower().get());
		}
	}
