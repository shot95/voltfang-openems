...
public class FieldTypeConflictHandler {
	...
	private void initializePredefinedHandlers() {
		...
		this.createAndAddHandler("airCon0/WaterInletPressure", RequiredType.FLOAT);
		this.createAndAddHandler("airCon0/WaterOutletPressure", RequiredType.INTEGER);
		this.createAndAddHandler("airCon0/WaterPressureInletTooHigh", RequiredType.FLOAT);
		this.createAndAddHandler("airCon0/WaterPressureOutletTooHigh", RequiredType.INTEGER);
		...
		this.createAndAddHandler("battery0/Tower0Module10SerialNumber", RequiredType.INTEGER);
		this.createAndAddHandler("battery0/Tower0Module11SerialNumber", RequiredType.STRING);
		this.createAndAddHandler("battery0/Tower0Module12SerialNumber", RequiredType.STRING);
		this.createAndAddHandler("battery0/Tower0Module13SerialNumber", RequiredType.STRING);
		this.createAndAddHandler("battery0/Tower0Module14SerialNumber", RequiredType.STRING);
		...
		this.createAndAddHandler("battery1/Tower0Module0SerialNumber", RequiredType.INTEGER);
		this.createAndAddHandler("battery1/Tower0Module1SerialNumber", RequiredType.INTEGER);
		this.createAndAddHandler("battery1/Tower0Module2SerialNumber", RequiredType.INTEGER);
		this.createAndAddHandler("battery1/Tower0Module3SerialNumber", RequiredType.INTEGER);
		this.createAndAddHandler("battery1/Tower0Module4SerialNumber", RequiredType.INTEGER);
		this.createAndAddHandler("battery1/Tower0Module5SerialNumber", RequiredType.INTEGER);
		this.createAndAddHandler("battery1/Tower0Module6SerialNumber", RequiredType.INTEGER);
		...
		this.createAndAddHandler("battery2/Tower1SubMasterFirmwareVersion", RequiredType.STRING);
		this.createAndAddHandler("battery3/MasterMcuFirmwareVersion", RequiredType.STRING);
		this.createAndAddHandler("battery3/PackCurrent", RequiredType.FLOAT);
		...
		this.createAndAddHandler("battery4/PackCurrent", RequiredType.FLOAT);
		...
		this.createAndAddHandler("battery6/PackCurrent", RequiredType.FLOAT);
		this.createAndAddHandler("battery7/MasterMcuFirmwareVersion", RequiredType.STRING);
		this.createAndAddHandler("battery7/PackCurrent", RequiredType.FLOAT);
		this.createAndAddHandler("battery8/MasterMcuFirmwareVersion", RequiredType.STRING);
		this.createAndAddHandler("battery8/PackCurrent", RequiredType.FLOAT);
		...
		this.createAndAddHandler("batteryA11/VwEcuHardwareNumber", RequiredType.STRING);
		this.createAndAddHandler("batteryA11/VwEcuHardwareVersionNumber", RequiredType.STRING);
		...
		this.createAndAddHandler("batteryA22/VwEcuHardwareNumber", RequiredType.STRING);
		...
		this.createAndAddHandler("ctrlEssTimeOfUseTariffDischarge0/Currency", RequiredType.STRING);
		...
		this.createAndAddHandler("gridcon0/DcdcMeasurementsAccumulatedDcUtilization", RequiredType.FLOAT);
		this.createAndAddHandler("gridcon0/DcdcMeasurementsCurrentStringA", RequiredType.FLOAT);
		this.createAndAddHandler("gridcon0/DcdcMeasurementsCurrentStringB", RequiredType.FLOAT);
		this.createAndAddHandler("gridcon0/DcdcMeasurementsCurrentStringC", RequiredType.FLOAT);
		this.createAndAddHandler("gridcon0/DcdcMeasurementsPowerStringA", RequiredType.FLOAT);
		this.createAndAddHandler("gridcon0/DcdcMeasurementsPowerStringB", RequiredType.FLOAT);
		this.createAndAddHandler("gridcon0/DcdcMeasurementsPowerStringC", RequiredType.FLOAT);
		this.createAndAddHandler("gridcon0/DcdcMeasurementsUtilizationStringA", RequiredType.FLOAT);
		this.createAndAddHandler("gridcon0/DcdcMeasurementsUtilizationStringB", RequiredType.FLOAT);
		...
		this.createAndAddHandler("kostalPiko1/DcCurrentString3", RequiredType.FLOAT);
		...
		this.createAndAddHandler("kostalPiko1/HomeConsumptionBat", RequiredType.FLOAT);
		...
		this.createAndAddHandler("kostalPiko1/HomeCurrentFromExtSensorL2", RequiredType.FLOAT);
		this.createAndAddHandler("kostalPiko1/HomeCurrentFromExtSensorL3", RequiredType.FLOAT);
		this.createAndAddHandler("kostalPiko1/HomeSelfConsumptionTotal", RequiredType.FLOAT);
