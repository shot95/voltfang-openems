...
@ObjectClassDefinition(//
		name = "Meter Janitza UMG 509 Pro", //
		description = "Implements the Janitza UMG 509 Pro power analyser.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Meter Janitza UMG 509 Pro [{id}]";
}
