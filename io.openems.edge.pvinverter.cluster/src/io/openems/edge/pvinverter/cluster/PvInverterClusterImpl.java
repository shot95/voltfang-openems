...
import io.openems.edge.pvinverter.api.MetaPvInverter;
...
public class PvInverterClusterImpl extends AbstractOpenemsComponent implements PvInverterCluster, MetaPvInverter,
	...
	private void passPvLimitToMaster() throws OpenemsNamedException {
		var pvInverters = this.getPvInverters();
		...
		// Apply limit
		int activePowerLimit = activePowerLimitOpt.get();
		ManagedSymmetricPvInverter masterInverter = this.componentManager.getComponent(this.config.masterInverter_id());
		masterInverter.setActivePowerLimit(activePowerLimit);
	}

	// TODO switch to OSGI component mapping
