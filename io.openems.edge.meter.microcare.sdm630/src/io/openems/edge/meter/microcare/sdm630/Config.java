...
@interface Config {
	...
	@AttributeDefinition(name = "Reduced Reading", description = "Limits the modbus read registers to the most relevant ones "
			+ "to cope with small baud rate.")
	boolean reducedReading() default false; // oEMS
