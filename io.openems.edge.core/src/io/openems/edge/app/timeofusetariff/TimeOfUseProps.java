...
public final class TimeOfUseProps {
	...
	public static final ArrayList<Component> getComponents(//
		...
		return Lists.newArrayList(//
				new Component(ctrlEssTimeOfUseTariffId, controllerAlias, "Controller.Ess.Time-Of-Use-Tariff",
						controllerProperties.build()), //
				new Component(timeOfUseTariffProviderId, providerAlias, providerFactoryId,
