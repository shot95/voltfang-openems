...
public class EntsoE extends AbstractOpenemsAppWithProps<EntsoE, Property, Type.Parameter.BundleParameter>
	...
	public static enum Property implements Type<Property, EntsoE, Type.Parameter.BundleParameter>, Nameable {
		...
		private final AppDef<? super EntsoE, ? super Property, ? super Parameter.BundleParameter> def;

		private Property(AppDef<? super EntsoE, ? super Property, ? super Parameter.BundleParameter> def) {
			this.def = def;
		}
		...
		@Override
		public AppDef<? super EntsoE, ? super Property, ? super Parameter.BundleParameter> def() {
			return this.def;
		}

		@Override
		public Function<GetParameterValues<EntsoE>, Parameter.BundleParameter> getParamter() {
