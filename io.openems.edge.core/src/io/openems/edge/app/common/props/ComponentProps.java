...
public final class ComponentProps {
	...
	/**
	 * Creates a {@link AppDef} for a input to select a {@link OpenemsComponent}
	 * with the starting id 'modbus' excluding aliases containing "internal".
	 *
	 * @param <APP> the type of the {@link OpenemsApp}
	 * @return the {@link AppDef}
	 */
	public static <APP extends OpenemsApp & ComponentUtilSupplier & AppManagerUtilSupplier> //
	AppDef<APP, Nameable, BundleProvider> pickModbusIdNotInternalComponents() {
		return pickModbusId(c -> !c.alias().trim().startsWith("_"));
	}

	/**
	 * Creates a {@link AppDef} for a input to select a {@link OpenemsComponent}
	 * with the starting id 'modbus' excluding aliases containing "internal" and only selecting serial bridges.
	 *
	 * @param <APP> the type of the {@link OpenemsApp}
	 * @return the {@link AppDef}
	 */
	public static <APP extends OpenemsApp & ComponentUtilSupplier & AppManagerUtilSupplier> //
	AppDef<APP, Nameable, BundleProvider> pickSerialModbusIdNotInternalComponents() {
		return pickModbusId(c -> !c.alias().trim().startsWith("_") && c.serviceFactoryPid().equals("Bridge.Modbus.Serial"));
	}

	/**
	 * Creates a {@link AppDef} for a input to select a {@link OpenemsComponent}
	 * with the starting id 'modbus' excluding aliases containing "internal" and only Tcp bridges.
	 *
	 * @param <APP> the type of the {@link OpenemsApp}
	 * @return the {@link AppDef}
	 */
	public static <APP extends OpenemsApp & ComponentUtilSupplier & AppManagerUtilSupplier> //
	AppDef<APP, Nameable, BundleProvider> pickTcpModbusIdNotInternalComponents() {
		return pickModbusId(c -> !c.alias().trim().startsWith("_") && c.serviceFactoryPid().equals("Bridge.Modbus.Tcp"));
	}
	// oEMS End
