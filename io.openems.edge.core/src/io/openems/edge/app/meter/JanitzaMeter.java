...
public class JanitzaMeter extends AbstractOpenemsAppWithProps<JanitzaMeter, Property, Parameter.BundleParameter>
	...
	public enum Property implements Type<Property, JanitzaMeter, Parameter.BundleParameter> {
		// Component-IDs
		METER_ID(AppDef.componentId("meter0")), // oEMS
		MODBUS_ID(AppDef.componentId("modbus1")), //
		// Properties
		ALIAS(alias()), //
		...
		TYPE(AppDef.copyOfGeneric(MeterProps.type(), def -> def // oEMS -> Exclude of MeterType
				.setRequired(true))), //
		INTEGRATION_TYPE(CommunicationProps.modbusType() //
				.setRequired(true)), //
		IP(MeterProps.ip() //
				.setDefaultValue("") // oEMS
				.setRequired(true) //
		...
		MODBUS_UNIT_ID(MeterProps.modbusUnitId() //
				.setRequired(true) //
				.setDefaultValue(1) // oEMS 6 to 1
				.setAutoGenerateField(false)), //

		INVERT_POWER(AppDef.of(JanitzaMeter.class) // oEMS
				.setDefaultValue(true) //
				.setTranslatedLabel("App.meter.invert.power.label") //
				.setTranslatedDescription("App.meter.invert.power.description") //
	...
	protected ThrowingTriFunction<ConfigurationTarget, Map<Property, JsonElement>, Language, AppConfiguration, OpenemsNamedException> appPropertyConfigurationFactory() {
		return (t, p, l) -> {
			...
			final var factoryId = this.getEnum(p, JanitzaModel.class, Property.MODEL).getFactoryId(); // oEMS
			...
			final var invertPower = this.getBoolean(p, Property.INVERT_POWER); // oEMS
			...
			case TCP -> {
				...
				components.add(new EdgeConfig.Component(tcpModbusId, alias + " " + getTranslation(l, "api.bridge"), "Bridge.Modbus.Tcp", // oEMS Alias
			...
			components.add(new EdgeConfig.Component(meterId, alias, factoryId, //
					JsonUtils.buildJsonObject() //
							...
							.onlyIf(invertPower, b -> b.addProperty("invert", true)) // oEMS
							.build()));
	...
	public enum JanitzaModel implements TranslatableEnum {
		// oEMS added factoryId , value is enum name
		UMG_96_RME("UMG_96_RME", "Meter.Janitza.UMG96RME", "Janitza Netzanalysator UMG 96RM-E"), //
		UMG_604("UMG_604", "Meter.Janitza.UMG604", "Janitza Netzanalysator UMG 604-PRO"), //
		UMG_511("UMG_511", "Meter.Janitza.UMG511", "Janitza Netzqualitätsanalysator UMG 511"), //
        UMG_509_PRO("UMG_509_PRO", "Meter.Janitza.UMG509Pro", "Janitza Spannungsqualitätsanalysator UMG 509 Pro"), //oEMS
		UMG_512_PRO("UMG_512_PRO", "Meter.Janitza.UMG511", "Janitza Netzqualitätsanalysator UMG 512 PRO"), //oEMS
		UMG_96_PA_MID("UMG_96_PA_MID", "Meter.Janitza.UMG509Pro", "Janitza Netzanalysator UMG 96-PA MID+"), //oEMS
		B_23_MID("B_23_MID", "Meter.Janitza.UMG509Pro", "Janitza MID-Energiezähler B23"), // oEMS
		;
		...
		private JanitzaModel(String value, String factoryId, String translation) {
			this.value = value;
