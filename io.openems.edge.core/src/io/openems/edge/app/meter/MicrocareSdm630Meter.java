 ...
 * </pre>
 */
// oEMS we do not use meter microcare
...
public class MicrocareSdm630Meter
	...
	public enum Property implements Type<Property, MicrocareSdm630Meter, Parameter.BundleParameter>, Nameable {
		...
		TYPE(MeterProps.type()), // oEMS remove exlude of GRID
		MODBUS_ID(AppDef.copyOfGeneric(ComponentProps.pickModbusIdNotInternalComponents(), def -> def // oEMS pickModbus
				.setRequired(true) //
				.setAutoGenerateField(false))), //
		MODBUS_UNIT_ID(AppDef.copyOfGeneric(MeterProps.modbusUnitId(), def -> def //
				.setRequired(true) //
				.setAutoGenerateField(false) //
				.setDefaultValue(1))), //oEMS 10 to 1
		MODBUS_GROUP(CommunicationProps.modbusGroup(MODBUS_ID, MODBUS_ID.def(), //
				MODBUS_UNIT_ID, MODBUS_UNIT_ID.def())), //
		//UNOFFICIAL_APP_WARNING(CommonProps.installationHintOfUnofficialApp()), // oEMS -> Comment
		;
