...
public class HeatingElement extends AbstractOpenemsAppWithProps<HeatingElement, Property, HeatingElementParameter>
	...
	public static enum Property implements Type<Property, HeatingElement, HeatingElementParameter>, Nameable {
		...
		// oEMS
		CHECK(AppDef.copyOfGeneric(CommonProps.defaultDef(), def -> {
			installationHint(def);
		})),
		;
	...
	// oEMS
	private static void installationHint(AppDef<HeatingElement, Property, HeatingElementParameter> def) {
		def.setTranslatedLabel("installationHint.label") //
				.setField(JsonFormlyUtil::buildFieldGroup, (app, property, l, parameter, field) -> {
					...
					fields.add(JsonFormlyUtil.buildText() //
							.setText(TranslationUtil.getTranslation(AbstractOpenemsApp.getTranslationBundle(l), "OnlineMonitoring.installationHint")) //
							.build());
