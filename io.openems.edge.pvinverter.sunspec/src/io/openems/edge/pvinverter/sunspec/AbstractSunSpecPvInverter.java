...
public abstract class AbstractSunSpecPvInverter extends AbstractOpenemsSunSpecComponent
	...
	protected void onSunSpecInitializationCompleted() {
		...
		// oEMS Start
		this.mapSunspecPointToFrequency();
		this.mapSunspecPointToActivePower();
		this.mapSunspecPointToReactivePower();
		this.mapSunspecPointToActiveProductionEnergy();
		this.mapSunspecPointToVoltage();
		this.mapSunspecPointToCurrent();
		this.mapSunspecPointToMaxApparentPower();
		// oEMS End
	}

	protected void mapSunspecPointToFrequency() {
	...
	protected void mapSunspecPointToReactivePower() {
		this.mapFirstPointToChannel(//
				ElectricityMeter.ChannelId.REACTIVE_POWER, //
				DIRECT_1_TO_1, //
				S701.VAR, S111.V_AR, S112.V_AR, S113.V_AR, S101.V_AR, S102.V_AR, S103.V_AR);
	...
	protected void mapSunspecPointToActiveProductionEnergy() {
	...
	protected void mapSunspecPointToMaxApparentPower() {
		this.mapFirstPointToChannel(//
	...
	protected void mapSunspecPointToVoltage() {
		// Voltage
	...
	protected void mapSunspecPointToCurrent() {
		// Current
		this.mapFirstPointToChannel(//
